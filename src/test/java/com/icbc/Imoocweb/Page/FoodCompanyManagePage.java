...
public class FoodCompanyManagePage extends BasePage{
	...
	//配餐公司名称sendkey
	public String SendkeyFoodCompName() throws Exception {
		logger.debug("配餐公司名称sendkey");
		return GetEleSendKey("foodcompany_name_ele");
	}
	//获取配餐公司子商户ID元素
	...
	//配餐公司子商户ID
	public void SendkeyFoodCompID() throws Exception {
		logger.debug("配餐公司子商户ID sendkey");
	}	
	//获取配餐公司联系人元素
	...
	//配餐公司联系人sendkey
	public String SendkeyFoodCompContact() throws Exception {
		logger.debug("配餐公司联系人sendkey");
	...
	//配餐公司邮箱sendkey
	public String SendkeyFoodCompMail() throws Exception {
		logger.debug("配餐公司邮箱sendkey");
	...
	//配餐公司地址sendkey
	public String SendkeyFoodCompAdress() throws Exception {
		logger.debug("配餐公司地址sendkey");
	...
	//修改配餐公司名称sendkey
	public String SendkeyEditFoodCompName() throws Exception {
		logger.debug("修改配餐公司名称sendkey");
		return GetEleSendKey("edit_companyname_ele");
	}
	//获取修改配餐公司联系人元素
	...
	//修改配餐公司联系人sendkey
	public String SendkeyEditFoodCompContact() throws Exception {
		logger.debug("修改配餐公司联系人sendkey");
		return GetEleSendKey("edit_contact_ele");
	}
	//获取修改配餐公司手机号元素
	...
	//修改配餐公司邮箱sendkey
	public String SendkeyEditFoodCompMail() throws Exception {
		logger.debug("修改配餐公司邮箱sendkey");
		return GetEleSendKey("edit_email_ele");
	}
	//获取修改配餐公司地址元素
	...
	//修改配餐公司地址sendkey
	public String SendkeyEditFoodCompAdress() throws Exception {
		logger.debug("修改配餐公司地址sendkey");
		return GetEleSendKey("edit_address_ele");
	}	
	//获取修改保存元素
